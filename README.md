| รหัสนักศึกษา | ชื่อ-นามสกุล | อีเมล | กลุ่ม |
| :--- | :--- | :--- | :--- |
| 673380600-0 | รัชนาท ประเสริฐศิลป์ | ratchanat.p@kkumail.com | 3 |
| 673380085-0 | นันทกร แสวงจิตร | nantakorn.sa@kkumail.com | 3 |
| 673380414-7 | พชรพงษ์ สาหล่อน | phatcharapong.s@kkumail.com | 3 |
| 673380607-6 | อนุชา ประมาระตา | anucha.pr@kkumail.com | 3 |
| 673380595-7 | พิชญพงษ์ ทองแม้น | pitchayapong.t@kkumail.com | 3 |
...
| ลำดับ | ชื่อ-นามสกุล | รหัสนักศึกษา | อีเมล | Section | Branch | หน้าที่รับผิดชอบ |
|---|---|---|---|---|---|---|
| 1 | พิชญพงษ์ ทองแม้น | 673380595-7 | pitchayapong.t@kkumail.com | 3 | `pitchayapong_6733805957_03` | ลูกค้าและพนักงาน (customer, employee, role), Global Exception Handler, DTO/Mapper convention, Thymeleaf layout กลาง |
| 2 | นันทกร แสวงจิตร | 673380085-0 | nantakorn.sa@kkumail.com | 3 | `nantakorn_6733800850_03` | ทรัพย์จำนำและการประเมินราคา (pledged_item, appraisal, gold_price), **Strategy Pattern** |
| 3 | รัชนาท ประเสริฐศิลป์ | 673380600-0 | ratchanat.p@kkumail.com | 3 | `ratchanat_6733806000_03` | ตั๋วจำนำและวงจรสถานะ (pawn_ticket), **State Pattern**, ธุรกรรมต่อดอกและไถ่ถอน |
| 4 | พชรพงษ์ สาหล่อน | 673380414-7 | phatcharapong.s@kkumail.com | 3 | `phatcharapong_6733804147_03` | สมุดบัญชีธุรกรรม (ledger_entry), นโยบายและการคำนวณดอกเบี้ยขั้นบันได (interest_policy, rate_tier) |
| 5 | อนุชา ประมาระตา | 673380607-6 | anucha.pr@kkumail.com | 3 | `anucha_6733806076_03` | ทรัพย์หลุดและการแจ้งเตือน (sale_record, notification_log), **Observer Pattern**, Docker, CI/CD, Deployment, Swagger |
